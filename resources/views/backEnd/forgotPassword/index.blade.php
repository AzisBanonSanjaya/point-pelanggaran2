...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Forgot Password - Sman 1 Banjaran</title>
            ...
            <div class="row justify-content-center">
                ...
                <div class="d-flex justify-content-center py-4">
                    <a href="{{route('forgot.password')}}" class="d-flex align-items-center w-auto">
                        <img src="{{ asset('assets/img/login.png')}}" alt="Sman 1 Banjaran" class="img-logo">
                    </a>
                </div><!-- End Logo -->
                ...
                <div class="card mb-3">
                    ...
                    <form action="{{route('send.forgot.password')}}" method="post" class="row g-3 needs-validation" novalidate>
                        @csrf
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            <p class="mb-0 text-end"><a href="{{route('login')}}">Sign In ?</a></p>
                          </div>
                    </form>
