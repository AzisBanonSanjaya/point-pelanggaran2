...
<body>
	<div class="box-construction">
		...
		{{-- <img src="{{ asset('underconstruction/img/animatpion.gif') }}" class="image-animation" alt=""> --}}
		<p class="text-title">Unauthorized</p>
		<p class="text-desc">Mohon maaf anda tidak memiliki wewenang untuk mengakses halaman ini</p>
		<div class="box-btn">
