...
class UserController extends Controller
{
    ...
    public function index(): View|Factory
    {
        ...
        $permissions = $this->permission->get(['id','name']);
        return view('backEnd.userManagement.user.index', compact('roles','permissions'));
    }
    ...
    public function fetchDataTable(Request $request): JsonResponse
    {
        ...
        $data = $users->map(function ($user) use (&$no) {
            return [
                ...
                'created_at' => $user->created_at->translatedFormat('d F Y H:i:s'),
                'actions' => '
                    <div class="dropdown">
